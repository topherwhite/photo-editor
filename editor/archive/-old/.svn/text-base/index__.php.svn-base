...
if ($view_nmbr > 1) { echo "<input type=\"button\" class=\"apply\" value=\"&lt;&lt;\""
								." onClick=\"location='?view=".($view_nmbr-1)."&alb={$_GET['alb']}&fltr={$_GET['fltr']}';\" />"; }
...
echo	""
		...
		."\n{$img['rnk']}<div class=\"popup\" id=\"popup_view_{$slct_id}\" style=\"visibility:hidden;"
