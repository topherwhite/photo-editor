...
if ($view_nmbr > 1) { echo "<input type=\"button\" class=\"apply\" value=\"&lt;&lt;\""
								." onClick=\"location='?view=".($view_nmbr-1)."&alb={$_GET['alb']}&fltr={$_GET['fltr']}&style={$_GET['style']}';\" />"; }
...
echo	""
		...
		."\n<div class=\"popup_{$slct_id}\" id=\"popup_view_{$slct_id}\" style=\"visibility:hidden;"
					."z-index:".($view_per_page-$slct_id).";\">"
			."<img class=\"popup_x\" id=\"popup_view_{$slct_id}_x\" src=\"/img/static/popup/x.png\""
				." onMouseOver=\"imghvr(1,'popup_view_{$slct_id}_x')\""
				." onMouseOut=\"imghvr(2,'popup_view_{$slct_id}_x')\""
		...
		."<div class=\"popup_{$slct_id}\" id=\"popup_meta_{$slct_id}\" style=\"visibility:hidden;"
					."z-index:".($view_per_page-$slct_id).";\">"
			."<img class=\"popup_x\" id=\"popup_meta_{$slct_id}_x\" src=\"/img/static/popup/x.png\""
				." onMouseOver=\"imghvr(1,'popup_meta_{$slct_id}_x')\""
				." onMouseOut=\"imghvr(2,'popup_meta_{$slct_id}_x')\""
		...
		."\n<div class=\"popup_{$slct_id}\" id=\"popup_cptn_{$slct_id}\" style=\"visibility:hidden;width:400px;height:400px;"
					."z-index:".($view_per_page-$slct_id).";\">"
			."<img class=\"popup_x\" id=\"popup_cptn_{$slct_id}_x\" src=\"/img/static/popup/x.png\""
				." onMouseOver=\"imghvr(1,'popup_cptn_{$slct_id}_x')\""
				." onMouseOut=\"imghvr(2,'popup_cptn_{$slct_id}_x')\""
				." onClick=\"popup(0,{$slct_id},'cptn');\""
				." />"
				
			."<textarea class=\"text_cptn\" id=\"text_cptn_{$slct_id}\"></textarea>"
			
			."<br /><br /><input class=\"apply\" type=\"button\" value=\"save\" onClick=\"check_changed()\" />"
		
		."</div>"	
		
		."\n<div class=\"meta_cell_{$slct_id}\" id=\"meta_{$slct_id}\"><table class=\"meta\"><tr>"
		
		."<td>"
		."</td>"
		
		."<td>"
		."<input class=\"apply\" type=\"button\" value=\"edit caption\" onClick=\"popup(1,{$slct_id},'cptn');\" />"
		."</td>"
...
echo 	" var val_text_cptn = new Array();";
		for ($i = 0; $i < $slct_id; $i++)
		{ echo 	" val_text_cptn[{$i}] = '';"; }
